    ...
    <footer className="bg-black text-white">
      ...
      <div className="max-w-screen-xl mx-auto px-4 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            {[
              { image: "/images/footer1.png", date: "20 Feb 2022", title: "Keep Your Business" },
              { image: "/images/footer2.png", date: "18 Feb 2022", title: "Manage Effectively" },
              { image: "/images/footer3.png", date: "15 Feb 2022", title: "Scale for Success" },
            ].map((post, idx) => (
      ...
      <div className="bg-[#4F4F4F] px-4 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between max-w-full mx-auto">
        <p className="text-sm text-gray-300 text-center md:text-left">
          © 2024 by <a href="https://example.com" className="text-[#FF9F0D]"> Wajahat Ali </a>. All Rights Reserved.
        </p>
